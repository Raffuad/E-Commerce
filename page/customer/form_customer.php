...
<form method="POST" action="proses_customer.php">
  <div class="form-group row mt-3">
    <label for="name" class="col-4 col-form-label h2" >Nama</label> 
    <div class="col-8">
      <div class="input-group">
  ...
  <div class="form-group row mt-3">
    ...
    <div class="col-2">
      <div class="input-group">
        ...
        <input id="gender" name="gender" 
        value="P" type="radio" class="form-control ms-2"> Perempuan
      </div>
    </div>
  </div>
  <div class="form-group row mt-3">
    <label for="phone" class="col-4 col-form-label h2">NO.HP</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row mt-3">
    <label for="email" class="col-4 col-form-label h2">Email</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row mt-3">
    <label for="address" class="col-4 col-form-label h2">Alamat</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row mt-3">
    <label for="Card" class="col-4 col-form-label h2">ID Card</label> 
    <div class="col-8">
    <?php
