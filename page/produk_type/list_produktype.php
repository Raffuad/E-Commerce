...
<html lang="en">
    ...
    $rs = $dbh->query($sql);
?>
<a class="btn btn-outline-success mb-2" href="form_produktype.php" role="button">Create Produk Type</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-outline-primary" href="view_produktype.php?id=<?=$row['id']?>">View</a>
                <a class="btn btn-outline-warning" href="form_produktype.php?id=<?=$row['id']?>">Edit</a>
                <a class="btn btn-outline-danger" href="delete_produktype.php?id=<?=$row['id']?>"
                onclick="if(!confirm('Anda Yakin Hapus Data produktype <?=$row['id']?>?')) {return false}"
                                >Delete</a>
            </td>
        </tr>
        <?php 
