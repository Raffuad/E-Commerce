...
<html lang="en">
    ...
    $rs = $dbh->query($sql);
?>
<a class="btn btn-outline-success mb-2" href="form_order.php" role="button">Create Order</a>
<table class="table table-dark table-striped">
    <thead>
        <tr>
            <th>ID</th><th>Order Number</th><th>Date</th>
            <th>Qty</th><th>Total_Price</th>
            <th>ID Customer </th><th>Produk ID</th>
            <th>Action</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-outline-primary" href="view_order.php?id=<?=$row['id']?>">View</a>
                <a class="btn btn-outline-warning" href="form_order.php?id=<?=$row['id']?>">Edit</a>
                <a class="btn btn-outline-danger" href="delete_order.php?id=<?=$row['id']?>"
